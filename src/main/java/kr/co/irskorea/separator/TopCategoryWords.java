...
public class TopCategoryWords {
    ...
    public static Map<Integer, String> readInverseDictionnary(Configuration conf, Path dictionnaryPath) {
        Map<Integer, String> inverseDictionnary = new HashMap<>();
    ...
    // java -jar classification-1.0-SNAPSHOT-jar-with-dependencies.jar /Users/cetauri/playground/irskorea/classfication/bin/model /Users/cetauri/playground/irskorea/classfication/bin/labelindex /Users/cetauri/playground/irskorea/classfication/bin/data-vectors/dictionary.file-0 /Users/cetauri/playground/irskorea/classfication/bin/data-vectors/df-count/part-r-00000
